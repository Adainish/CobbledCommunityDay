package io.github.adainish.cobbledcommunityday.scheduler;
...
public class AsyncTask
{
    ...
    private AsyncTask(int interval, int iterations, Runnable runnable, Consumer<Void> consumerTask) {
    ...
    public void start() {
        ...
        CobbledCommunityDay.getLog().debug("Starting async scheduler with interval of {} ticks and {} iterations", interval, iterations);
    ...
    public static class Builder {
        ...
        public AsyncTask build() {
            ...
            return new AsyncTask(interval, iterations, runnable, consumerTask);
        }
    }
}
